(function () {
	...
	if (getLeadsBySourceId) {
		var options = {
			...
			colors: [
				"#1174f9", "#3584FC", "#AD63F6", "#0dcaf0", "#25B003", "#FD5812"
			],
			stroke: {
				width: 1,
				show: true,
	...
	if (getTasksOverview4Id) {
		var options = {
			...
			colors: [
				"#37D80A", "#1174f9", "#AD63F6", "#3584FC", "#FD5812"
			],
			dataLabels: {
				enabled: false
			},
	...
	if (getNewAdmissionsId) {
		var options = {
			...
			colors: [
				"#37D80A", "#FF4023", "#1174f9", "#AD63F6", "#90C7FF"
			],
			stroke: {
				width: 1,
				show: true,
		...
		var options = {
			...
			chart: {
				...
				dropShadow: {
					...
					blur: 3,
					opacity: 0.6,
					color: "#1174f9" // Custom color for the shadow
				}
			},
			colors: [
				"#1174f9", "#DDE4FF"
	...
	if (getFacebookCampaignOverviewId) {
		var options = {
			...
			colors: ["#1174f9", '#BF85FB', '#37D80A', '#FD5812'],
			grid: {
				borderColor: '#ECEEF2',
				strokeDashArray: 8,
				xaxis: {
	...
	if (getSpendingBreakdownId) {
		...
		document.addEventListener("DOMContentLoaded", function () {
			...
			const options = {
				...
				labels: labels,
				colors: ["#37D80A", "#FE7A36", "#3584FC", "#FF4023", "#AD63F6", "#1174f9"],
				stroke: {
					width: 2,
					show: true,
					colors: ["#ffffff"]
	...
	if (getMarketPerformanceId) {
		...
		const options = {
			...
			colors: [
				"#37D80A", "#3584FC", "#FE7A36", "#AD63F6", "#FF4023", "#1174f9"
			],
			stroke: {
				width: 0,
				show: true,
	...
	if (getAssetAllocationId) {
		...
		document.addEventListener('DOMContentLoaded', function () {
			const options = {
				...
				colors: [
					"#1174f9", "#757DFF", "#9CAAFF", "#C2CDFF", "#DDE4FF"
				],
				legend: {
					show: true,
					fontSize: '12px',
